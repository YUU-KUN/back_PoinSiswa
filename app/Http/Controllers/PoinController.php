    	...
    	try{
	        ...
	        $dataPoin = DB::table('poin_siswa')	->join('siswa','siswa.id','=','poin_siswa.id_siswa')
                                            	->join('pelanggaran','pelanggaran.id','=','poin_siswa.id_pelanggaran')
																							->select('poin_siswa.id', 'siswa.nama_siswa','siswa.kelas','siswa.nis','pelanggaran.nama_pelanggaran','pelanggaran.kategori', 'pelanggaran.poin', 
																							'poin_siswa.tanggal','poin_siswa.id_siswa','pelanggaran.id as id_pelanggaran','poin_siswa.keterangan')
	                                           	->get();
